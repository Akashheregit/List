...
function Home() {
  ...
  return (
    ...
    <div className=' p-2 w-[80%] flex flex-col gap-16'>
        ...
        <input type='text' placeholder='Search' className='bg-gray-300 p-1 rounded'></input>
        <AiOutlineBell className='text-3xl'/>
        <BiUserCircle  className='text-3xl'/>
         </div>
        </div>

        <div className="flex h-[10%] justify-evenly w-[100%]  ">

        <div class=" bg-[#ddefe0] p-16 justify-center items-center rounded-xl w-[20%] " >
          <h2>Total Revenues</h2>
          <ul>
            <li>$2,129,430</li>
          </ul>
        </div>
        <div class="bg-[#f4ecdd] p-16 justify-center items-center rounded-xl  w-[20%]">
          <h2>Total Transactions</h2>
          <ul>
            <li>1,520</li>
          </ul>
        </div>
        <div class="bg-[#efdada] p-16 justify-center items-center rounded-xl  w-[20%]">
          <h2>Total Likes</h2>
          <ul>
            <li>9,721</li>
          </ul>
